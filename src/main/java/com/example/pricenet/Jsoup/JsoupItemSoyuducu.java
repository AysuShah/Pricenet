...
public class JsoupItemSoyuducu {
    public static void main(String[] args) throws IOException {


        Document pageCount = Jsoup.connect("https://qiymeti.net/qiymetleri/soyuducu/").get();
        ...
        for (int i = 1; i <= Integer.parseInt(pageNumber); i++) {
            ...
            Document document = Jsoup.connect("https://qiymeti.net/qiymetleri/soyuducu/page/" + i).get();
            ...
            for (Element product : products) {
                ...
                Document document2 = Jsoup.connect("https://qiymeti.net/soyuducu/" + attr).get();
