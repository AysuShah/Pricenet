...
public class JsoupPlanset {
    public static void main(String[] args) throws IOException {
        ...
        Document pageCount = Jsoup.connect("https://qiymeti.net/qiymetleri/planset/").get();
        ...
        for (int i = 1; i <= Integer.parseInt(pageNumber); i++) {
            ...
            Document document = Jsoup.connect("https://qiymeti.net/qiymetleri/planset/page/" + i).get();
