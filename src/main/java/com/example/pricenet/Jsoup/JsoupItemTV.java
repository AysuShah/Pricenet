...
public class JsoupItemTV {
    public static void main(String[] args) throws IOException {


        Document pageCount = Jsoup.connect("https://qiymeti.net/qiymetleri/televizor/").get();
        ...
        for (int i = 1; i <= Integer.parseInt(pageNumber); i++) {
            ...
            Document document = Jsoup.connect("https://qiymeti.net/qiymetleri/televizor/page/" + i).get();
            ...
            for (Element product : products) {
                ...
                Document document2 = Jsoup.connect("https://qiymeti.net/televizor/" + attr).get();
