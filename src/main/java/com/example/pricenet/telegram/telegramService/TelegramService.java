...
import com.example.pricenet.telegram.dto.update.TelegramResponseDTO;
import com.example.pricenet.telegram.dto.update.TelegramUpdateDTO;
...
//              repository.save(byChatId);
                ...
                if (text.equals("/start")) {
                    ...
                    sendMessage("Pricenet botuna xoş gəlmisiniz. Zəhmət olmasa xidməti seçin", id);
